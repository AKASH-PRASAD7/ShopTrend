              ...
              <div className="mt-4 lg:row-span-3 lg:mt-0">
                ...
                <div className="mt-6">
                  ...
                  <div className="flex items-center">
                    <div className="flex items-center">
                      <Rating
                        size={"large"}
                        value={Math.round(productDetails.rating)}
                      />
                    </div>
                ...
                <form className="mt-10">
                  ...
                  <Link to="/cart">
                    <button
                      type="submit"
                      className="mt-10 text-xl flex w-full items-center justify-center rounded-md border border-transparent bg-blue-600 px-8 py-3 text-base font-medium text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                    >
